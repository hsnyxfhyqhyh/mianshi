...
2. Client calls the concrete building's orderShip method (defined in the abstract building class) with type of ship it wants as parameter, 
return object is an abstract ship.
