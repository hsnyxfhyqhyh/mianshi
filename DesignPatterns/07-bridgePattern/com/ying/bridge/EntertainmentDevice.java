...
abstract class EntertainmentDevice {
	...
	public int deviceState;	//the current setting for channel number if it is TV, or chapter number if it is DVD.  
	
	public int maxSetting;	//the max setting for channel number if it is TV, or chapter number if it is DVD. 
